...
?>
	...
	<?php if(isset($_SESSION['add-category-success'])) : //shows if category was a success?>
		...
		<?php elseif (isset($_SESSION['edit-category'])) : //shows if category was a edited errror?>
		 <div class="alert__message error container">
			<p>
		...
		<?php elseif (isset($_SESSION['edit-category-success'])) : //shows if category was a edited success?>
		 <div class="alert__message success container">
			<p>
		...
		<?php elseif (isset($_SESSION['delete-category-success'])) : //shows if category was a edited success?>
		 <div class="alert__message success container">
			<p>
